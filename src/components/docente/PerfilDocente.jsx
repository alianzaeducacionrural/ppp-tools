...
export function PerfilDocente() {
  ...
  const nombreMostrado = docente?.nombre_completo || user?.email?.split('@')[0] || 'Docente'
          ...
          <div className="bg-white rounded-2xl border border-[#e8dcca] overflow-hidden">
            ...
            <div className="p-4 sm:p-5 grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="bg-[#faf7f3] rounded-xl p-3 border border-[#e8dcca]">
                ...
                <p className="text-sm font-medium text-[#4a3222]">{docente?.nombre_completo || 'No especificado'}</p>
              </div>
              <div className="bg-[#faf7f3] rounded-xl p-3 border border-[#e8dcca]">
              ...
              <div className="bg-[#faf7f3] rounded-xl p-3 border border-[#e8dcca] sm:col-span-2">
                ...
                <p className="text-sm font-medium text-[#4a3222]">
                  {docente?.instituciones?.nombre || 'N/A'} · {docente?.municipios?.nombre || 'N/A'}
                </p>
              </div>
            </div>
          </div>
