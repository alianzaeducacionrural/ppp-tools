...
export function RegistroDocente() {
  ...
  async function handleSubmit(e) {
    ...
    if (docenteError) {
      toast.error('Error al guardar tus datos: ' + docenteError.message)
      console.error(docenteError)
    } else {
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-br from-[#2c1810] via-[#4a3222] to-[#7a5c48] p-6 text-center relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <h1 className="text-xl font-bold text-white">Registro de Docente</h1>
              <p className="text-[#d4c4a8] text-xs mt-1">Maestro PPP · Proyectos Dirigidos</p>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div>
                    <label className="block text-[#4a3222] font-medium mb-1 text-sm">Teléfono *</label>
                    <input
                      type="tel"
                      name="telefono"
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  <span className="text-sm">📍</span>
                  <h3 className="text-[10px] font-bold uppercase tracking-widest text-[#a68a64]">Ubicación de la Institución</h3>
                  <div className="flex-1 h-px bg-[#e8dcca]" />
                </div>
                ...
                <p className="text-xs text-[#a68a64] mt-2">
                  Tus proyectos dirigidos usarán automáticamente esta ubicación — no tendrás que repetirla.
                </p>
              </div>
