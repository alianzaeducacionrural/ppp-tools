    ...
    return (
      <div className="space-y-6">
        <div className="animate-pulse">
          <div className="bg-gradient-to-r from-[#6b4c3a] to-[#4a3222] rounded-2xl p-6">
            <div className="h-4 bg-white/20 rounded w-1/3 mb-2"></div>
            <div className="h-10 bg-white/20 rounded w-1/4"></div>
          </div>
          <div className="mt-6 space-y-3">
            {[1, 2, 3].map(i => (
              <div key={i} className="bg-white rounded-xl p-4 shadow-sm border border-[#e8dcca]">
          ...
          <div className="flex flex-col md:flex-row justify-center items-end gap-4">
            ...
            {top3[1] && (
              <div className="order-1 md:order-1 w-full md:w-72 text-center transform transition-all duration-300 hover:scale-105">
                <div className="relative">
                  <div className="w-20 h-20 mx-auto rounded-full bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center text-4xl shadow-lg border-4 border-gray-300">
            ...
            {top3[0] && (
              <div className={`order-0 md:order-2 w-full md:w-80 text-center transform transition-all duration-300 hover:scale-105 ${estudiante?.id === top3[0]?.id ? 'ring-4 ring-yellow-400 rounded-2xl' : ''}`}>
                <div className="relative">
                  <div className="w-28 h-28 mx-auto rounded-full bg-gradient-to-br from-yellow-100 to-yellow-200 flex items-center justify-center text-5xl shadow-xl border-4 border-yellow-400">
            ...
            {top3[2] && (
              <div className="order-2 md:order-3 w-full md:w-72 text-center transform transition-all duration-300 hover:scale-105">
                <div className="relative">
                  <div className="w-20 h-20 mx-auto rounded-full bg-gradient-to-br from-amber-100 to-amber-200 flex items-center justify-center text-4xl shadow-lg border-4 border-amber-300">
